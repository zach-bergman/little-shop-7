  ...
  describe 'as a merchant' do
    ...
    describe 'top five items' do
      before do
        ...
        @invoice_item_1 = create(:invoice_item, item: @item_1, invoice: @invoice_1, quantity: 1, unit_price: 1)
        @invoice_item_2 = create(:invoice_item, item: @item_2, invoice: @invoice_2, quantity: 2, unit_price: 2)
        @invoice_item_3 = create(:invoice_item, item: @item_3, invoice: @invoice_3, quantity: 3, unit_price: 3)
        @invoice_item_4 = create(:invoice_item, item: @item_4, invoice: @invoice_4, quantity: 4, unit_price: 4)
        @invoice_item_5 = create(:invoice_item, item: @item_5, invoice: @invoice_5, quantity: 5, unit_price: 5)
        @invoice_item_6 = create(:invoice_item, item: @item_6, invoice: @invoice_6, quantity: 6, unit_price: 6)
        @invoice_item_7 = create(:invoice_item, item: @item_7, invoice: @invoice_1, quantity: 7, unit_price: 7)
        @invoice_item_8 = create(:invoice_item, item: @item_8, invoice: @invoice_2, quantity: 8, unit_price: 8)
