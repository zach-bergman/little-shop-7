...
RSpec.describe "Merchant Bulk Discount New Page" do
  describe "User Story 2 - Merchant Bulk Discount Create" do
    describe "As a merchant, when I visit my merchant bulk discount new page" do
      it "shows a form to add a new bulk discount and 
      redirects back to the merchant bulk discounts index page when form is submitted" do
      ...
      it "returns an error message if bulk discount name already exists" do
        merchant_1 = create(:merchant)
